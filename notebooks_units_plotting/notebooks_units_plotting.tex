...
\begin{frame}{Cellules}
	...
	\begin{itemize}
		\item[$\triangleright$] Une cellule de code contient du code.
		\item[$\triangleright$] Une cellule de \emph{Markdown} contient du texte, au format Markdown :
		\begin{itemize}
...
\begin{frame}{Jupyter notebook}
	...
	Pour inclure du code Julia dans un Jupyter notebook, il faut installer l'environnement de développement Jupyter, inclus dans Anaconda par exemple, ainsi que la bibliothèque IJulia.jl en Julia. Il est aussi possible d'éditer des Jupyter notebook directement dans VSCode.
\end{frame}
...
\begin{frame}[fragile]{Markdown dans Pluto}
	...
	\begin{minted}{julia}
		md"""
		This is my Markdown comment. It can do interpolation: `x = $x`
		"""
	\end{minted}
	\vfill
...
\begin{frame}{Backend}
	...
	\JL{using GLMakie}
	(On peut aussi utiliser \jl{using CairoMakie} ou \jl{using WGLMakie} à la place.)
\end{frame}
